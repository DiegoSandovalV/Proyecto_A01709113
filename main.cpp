...
int main() {
    ...
    cout << "Guitarra 1: \n" << guitarra1.get_marca() << endl << guitarra1.get_modelo() << endl << guitarra1.get_sonido()
    ...
    Piano piano1("Yamaha","Grand","Acustico","Sin sintetizador",88,13,2);
    ...
    //Prueba de crear objeto de la clase Piano
    Violin violin1("Yamaha","Artida","Acustico","Nylon","No incluido",8,8);

    //Se mandan a llamar los getters para demostrar su funcionamiento
    cout << "Violin 1: \n" << violin1.get_marca() << endl <<violin1.get_modelo() << endl << violin1.get_sonido()
